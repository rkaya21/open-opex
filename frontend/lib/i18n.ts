...
const tr = {
  ...
  suggestions: {
    ...
    info: {
      ...
      what: "NELER ÖNERİDİR?",
      whatItems: [
        "İş güvenliğini, kaliteyi, verimliliği veya çalışma ortamını iyileştiren somut fikirler öneridir.",
        "5S: Kaliteli bir çalışma ortamı oluşturmak ve sürekliliğini sağlamak için geliştirilen bir tekniktir.",
        "SEÇ (Sağlık, Emniyet, Çevre): Çalışanların sağlığını ve çevreyi korumaya yönelik uygulamalardır.",
        "İnsana Saygı: Bireylerin haklarına ve değerlerine saygı gösterilmesini ifade eder.",
        "KAIZEN: Küçük adımlarla sürekli iyileştirme yaklaşımıdır.",
        "Otonom Bakım: Operatörün kendi ekipmanının temel bakımını üstlenmesidir.",
      ],
      whatNot: "NELER ÖNERİ DEĞİLDİR?",
      whatNotItems: [
        "Yemeğe, servise veya ücret standardına yönelik şikayetler öneri olarak değerlendirilmez.",
        "Yöneticiye yönelik şikayetler öneri olarak değerlendirilmez.",
        "Yapılmış çalışmalar tekrar öneri olarak verilmemelidir.",
        "Daha önce iletilmiş fikirler yeniden değerlendirilmez.",
        "Devam eden çalışmalar için değerlendirme yapılmaz.",
        "Spesifik olmayan fikirler değerlendirmeye alınmaz.",
      ],
      ok: "Tamam",
    },
  },
...
const en: Dictionary = {
  ...
  suggestions: {
    ...
    info: {
      ...
      whatItems: [
        "Concrete ideas that improve safety, quality, efficiency or the work environment are suggestions.",
        "5S: a technique for creating and sustaining a high-quality workplace.",
        "HSE (Health, Safety, Environment): practices protecting worker health and the environment.",
        "Respect for People: honoring individuals' rights and values.",
        "KAIZEN: continuous improvement through small steps.",
        "Autonomous Maintenance: operators owning basic care of their own equipment.",
      ],
      whatNot: "WHAT IS NOT A SUGGESTION?",
      whatNotItems: [
        "Complaints about food, shuttle service or pay standards are not suggestions.",
        "Complaints about managers are not evaluated as suggestions.",
        "Work already done should not be resubmitted as a suggestion.",
        "Previously submitted ideas are not evaluated again.",
        "Ongoing work is not evaluated.",
        "Non-specific ideas are not taken into evaluation.",
      ],
      ok: "OK",
    },
  },
